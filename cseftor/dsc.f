...
c    z2_in       real(3152110,6)       z2 at same node points
c    t_in        real(3152110,6)       t  at same node points
...
c
     ...
     1 nmb(6),stiwl(1521,5),dlam(61),weight(61)
c
...
c     -- define pi
      data pi/3.1415926/
      data cntrwl/3175.00,3250.00,3400.00,3880.00/
c
c     ------------------------
c
...
c           -- open file corresponding to correct ozone profile
            if (ipres.eq.1) then
              open (33,file='/home/cseftor/dev/tomrad/OMTO3LUT/tomrad/v2.24/'
