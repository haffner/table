...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     1 sb_in(3040), t_in(3040,10,6)
      ...
      real dlam, weight
c
      common/array/wl(3040),fitflux(3040),cntrwl(12),output(6,5),
...
c     -- read in spectral functions (wavelengths and weights)
      open (40,file='omi_slit.dat',status='old')
      read (40,*) dlam
      print *,dlam
      read (40,*) weight
      close (40)
...
c     -- correspond to the middle)
      open (20,file='omiwav.dat',status='old')
      read (20,*) cntrwl
      read (20,*) 
      close (20)
      do jj = 1,1
...
c       -- part of the CCD array
        open (31,file='data/TABLE.OMI',status='unknown',
     1   form='unformatted')
