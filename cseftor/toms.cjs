...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     1 sb_in(1521), t_in(1521,10,6)
      ...
      real i0
      character*25  direc(4)
      character*1 position(7)
      integer lun
      real dlam, weight
c
      common/array/wl(1521),fitflux(1521),cntrwl(6),output(6,5),
     1 nmb(6),stiwl(1521,5),dlam(41),weight(41)
c
c     -- Master table path
      data direc/'/omps/dev/cseftor/MASTER/',
     1           '/omps/dev/cseftor/MASTER/',
     2           '/omps/dev/cseftor/MASTER/',
     3           '/omps/dev/cseftor/MASTER/'/
      data atm/'atm10','atm07','atm04','atm25'/
...
c     -- correspond to the middle)
      open (20,file='toms_wav.dat',status='old')
      read (20,*) cntrwl
      read (20,*) 
      close (20)
      do jj = 1,1
...
c       -- part of the CCD array
	open (31,file='data/TABLE.N7',status='unknown',
     1   form='unformatted')
